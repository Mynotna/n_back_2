                        ...
                        if current_event_index in self.player_responses:
                            ...
                            if current_position_key is None and current_number_key is None:
                                ...
                                if event.key == pygame.K_g:
                                    ...
                                    position_response_time_sec = response_time_ms / 1000.0
                                    logger.info(
                                        f"g pressed: {current_event_index}/nResponse time for g: {position_response_time_sec}")
                                ...
                                if event.key == pygame.K_j:
                                    ...
                                    number_response_time_sec = response_time_ms / 1000.0
                                    logger.info(
                                        f"j pressed: {current_event_index}/n Response time: {number_response_time_sec} ")
                                logger.info(f"player_responses: {self.player_responses}")
                                self.response_times[current_event_index] = (
                                position_response_time_sec, number_response_time_sec)
